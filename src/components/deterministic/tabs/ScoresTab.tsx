          ...
          {breakdown.map((r) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[11px] text-gray-600 w-28 truncate shrink-0">{r.name.replace(/ score$/i, "")}</span>
                ...
                <span className="text-[11px] text-black w-8 text-right shrink-0">{(r.value as number).toFixed(1)}</span>
                <span className="text-[10px] text-gray-400 w-10 text-right shrink-0">{(weight * 100).toFixed(0)}%</span>
                <span className="text-[10px] text-yellow-600 w-10 text-right shrink-0">{weighted.toFixed(1)}</span>
              </FactorTooltip>
            );
          })}
        </div>
