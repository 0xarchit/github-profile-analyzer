...
const PieChart = dynamic(
  () =>
    import("@/components/retroui/charts/PieChart").then((m) => ({
      default: m.PieChart,
    })),
  { ssr: false },
);
const LineChart = dynamic(
  () =>
    import("@/components/retroui/charts/LineChart").then((m) => ({
      default: m.LineChart,
    })),
  { ssr: false },
);
...
export function StatsDashboard({ data }: { data: AnalysisResult }) {
  ...
  return (
    <div className="space-y-12 sm:space-y-14 md:space-y-16 animate-in fade-in">
      <section className="space-y-6 sm:space-y-8">
        <div className="flex items-center gap-3 sm:gap-4 animate-in fade-in slide-in-from-bottom-4">
      ...
      <section className="space-y-6 sm:space-y-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4 border-b-6 sm:border-b-8 border-black pb-4 sm:pb-6 animate-in fade-in slide-in-from-bottom-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          <div className="neo-card bg-neo-yellow/10 p-6 sm:p-8 space-y-4 sm:space-y-6 relative group overflow-hidden animate-in fade-in slide-in-from-bottom-4">
          ...
          <div className="neo-card bg-neo-blue/10 p-6 sm:p-8 space-y-4 sm:space-y-6 relative group overflow-hidden animate-in fade-in slide-in-from-bottom-4">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
        <div className="neo-card bg-white p-6 sm:p-8 space-y-6 sm:space-y-8 border-4 shadow-neo-lg hover:shadow-neo transition-all animate-in fade-in slide-in-from-bottom-4">
      ...
      <section className="neo-card bg-white p-8 sm:p-10 md:p-12 space-y-8 sm:space-y-10 md:space-y-12 border-4 border-black relative overflow-hidden shadow-neo-lg group animate-in fade-in slide-in-from-bottom-4">
...
function MetricCard({
  ...
  return (
    <div
      className={`neo-card ${color} p-4 sm:p-5 md:p-6 border-3 sm:border-4 flex flex-col items-center justify-center text-center space-y-2 sm:space-y-3 md:space-y-4 group hover:bg-black hover:text-white transition-all duration-300 ease-in-out shadow-neo-lg cursor-pointer hover:scale-102 active:scale-98 animate-in fade-in`}
    >
      <div
