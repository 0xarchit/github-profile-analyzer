...
export function interpretE9Tags(
  ...
  return [
    ...
    tag("issue-closer", "Issue closer", issueTotal >= 5 && issueCloseRatio >= 0.65, issueCloseRatio * 100, "Authored issue activity shows a high observed close share in the bounded search sample.", [data.search.issuesClosed + " closed / " + issueTotal + " opened-or-closed issues"], ["1.29", "4.18"]),
    tag("documentation-first", "Documentation-first", score("2.10") >= 65, score("2.10"), "Documentation coverage scores strongly across the sampled public repositories.", ["Documentation score " + score("2.10")], ["2.10", "1.15"]),
